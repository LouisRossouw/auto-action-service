...
class Settings():
    def __init__(self):
        ...
        self.devices = read_json(os.path.join(self.configs_dir, "devices.json"))  # nopep8
        self.actions = read_json(os.path.join(self.configs_dir, "actions.json"))  # nopep8
        self.schedules = read_json(os.path.join(self.configs_dir, "schedules.json"))  # nopep8

        self.devices_by_slug = {d["slug"]: d for d in self.devices}
